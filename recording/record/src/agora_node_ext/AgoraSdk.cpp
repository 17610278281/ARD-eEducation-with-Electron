...
void AgoraSdk::onLeaveChannelImpl(agora::linuxsdk::LEAVE_PATH_CODE code) {
    ...
    agora::recording::node_async_call::async_call([this, code]() {
        MAKE_JS_CALL_1(REC_EVENT_LEAVE_CHANNEL, int32, code);
    });
}
...
void AgoraSdk::onUserOfflineImpl(unsigned uid, agora::linuxsdk::USER_OFFLINE_REASON_TYPE reason) {
    ...
    agora::recording::node_async_call::async_call([this, uid, reason]() {
        MAKE_JS_CALL_2(REC_EVENT_USER_LEAVE, uid, uid, int32, reason);
    });
}
